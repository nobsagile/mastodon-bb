    ...
    <div className="min-h-screen bg-[#f2f2f2] text-[#222] flex flex-col font-sans antialiased overflow-x-hidden" style={{ WebkitFontSmoothing: "antialiased" }}>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="https://github.com/nobsagile/mastodon-bb"
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-400 hover:text-slate-700 p-1.5 transition-colors border border-transparent hover:border-slate-200 hover:bg-slate-50"
            style={{ borderRadius: "4px" }}
